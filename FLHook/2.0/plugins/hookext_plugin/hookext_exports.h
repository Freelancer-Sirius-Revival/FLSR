...
IMPORT void IniSetWS(uint client, const std::string &name,
                     const std::wstring &value);
IMPORT void IniSetS(uint client, const std::string &name,
...
IMPORT void IniSetWS(const std::wstring &charname, const std::string &name,
                     const std::wstring &value);
IMPORT void IniSetS(const std::wstring &charname, const std::string &name,
                    const std::string &value);
IMPORT void IniSetI(const std::wstring &charname, const std::string &name,
                    uint value);
IMPORT void IniSetB(const std::wstring &charname, const std::string &name,
                    bool value);
IMPORT void IniSetF(const std::wstring &charname, const std::string &name,
                    float value);
}; // namespace HookExt
