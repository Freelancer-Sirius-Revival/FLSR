...
int HkIClientImpl::Send_FLPACKET_COMMON_UPDATEOBJECT(uint iClientID, SSPObjUpdateInfoClient& pUpdate)
{
	//ISERVER_LOG();
	//ISERVER_LOGARG_UI(iClientID);

	CALL_PLUGINS(PLUGIN_HkIClientImpl_Send_FLPACKET_COMMON_UPDATEOBJECT, bool, __stdcall, (uint, SSPObjUpdateInfoClient&), (iClientID, pUpdate));
...
bool HkIClientImpl::Send_FLPACKET_SERVER_ACTIVATEOBJECT(uint iClientID, XActivateObject& aq)
{
	ISERVER_LOG();
	ISERVER_LOGARG_UI(iClientID);

	CALL_PLUGINS(PLUGIN_HkIClientImpl_Send_FLPACKET_SERVER_ACTIVATEOBJECT, bool, __stdcall, (uint, XActivateObject&), (iClientID, aq));
...
void HkIClientImpl::Send_FLPACKET_COMMON_POP_UP_DIALOG(uint clientId, FmtStr* heading, FmtStr* text, uint buttons)
{
	ISERVER_LOG();
	ISERVER_LOGARG_UI(clientId);

	CALL_PLUGINS_V(PLUGIN_HkIClientImpl_Send_FLPACKET_COMMON_POP_UP_DIALOG, __stdcall, (uint, FmtStr*, FmtStr*, uint), (clientId, heading, text, buttons));

	CALL_CLIENT_METHOD(Send_FLPACKET_COMMON_POP_UP_DIALOG(clientId, heading, text, buttons));
	return;
}
