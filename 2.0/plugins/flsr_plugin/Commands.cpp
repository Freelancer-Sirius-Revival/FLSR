...
namespace Commands {
    ...
    void UserCMD_ENABLECARRIER(uint iClientID, const std::wstring &wscParam) {
        if (Modules::GetModuleState("CarrierModule")) {
            ...
            //�berpr�fe ob Spieler ein Carrier sein kann (Schiff)
            // Get ShipArchID
            ...
            // �berpr�fe ob der Spieler bereits ein Carrier ist
    ...
    void UserCMD_DOCKREQUEST(uint iClientID, const std::wstring &wscParam) {
        if (Modules::GetModuleState("CarrierModule")) {
            ...
            //�berpr�fe ob Spieler ein Carrier ist
            ...
            // �berpr�fe ob der Spieler ein Carrier ist
    ...
    void UserCMD_DOCKACCEPT(uint iClientID, const std::wstring &wscParam) {
        if (Modules::GetModuleState("CarrierModule")) {
            ...
            // Nur wenn die ClientID g�ltig ist den Spieler Docken
