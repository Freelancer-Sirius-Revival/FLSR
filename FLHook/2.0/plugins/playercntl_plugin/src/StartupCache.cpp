...
typedef int(__stdcall *_ReadCharacterName)(const char *filename,
                                           st6::wstring *str);
...
void Init() {
    ...
    {
        BYTE patch[] = {
            0x5f, 0x5e, 0x5d, 0x5b, 0x81, 0xC4, 0x08,
            0x11, 0x00, 0x00, 0xC2, 0x04, 0x00}; // pop regs, restore esp, ret 4
...
void Done() {
    ...
    {
        BYTE patch[] = {0x8b, 0x35, 0xc0, 0x4b, 0xd6, 0x06, 0x6a,
                        0x00, 0x68, 0xB0, 0xB8, 0xD6, 0x06};
        WriteProcMem((char *)hModServer + 0x76b3e, patch, 13);
    }
