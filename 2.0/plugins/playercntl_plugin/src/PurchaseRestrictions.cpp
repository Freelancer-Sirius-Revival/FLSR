...
typedef std::multimap<uint, uint, std::less<uint>>::value_type
    mapnobuy_map_pair_t;
typedef std::multimap<uint, uint, std::less<uint>>::iterator
    mapnobuy_map_iter_t;
...
typedef std::multimap<uint, uint, std::less<uint>>::value_type
    mapGoodItemRestrictions_map_pair_t;
typedef std::multimap<uint, uint, std::less<uint>>::iterator
    mapGoodItemRestrictions_map_iter_t;
...
typedef std::multimap<uint, uint, std::less<uint>>::value_type
    mapShipItemRestrictions_map_pair_t;
typedef std::multimap<uint, uint, std::less<uint>>::iterator
    mapShipItemRestrictions_map_iter_t;
