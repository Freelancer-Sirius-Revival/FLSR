...
EXPORT PLUGIN_INFO *Get_PluginInfo()
{
    ...
    p_PI->lstHooks.push_back(PLUGIN_HOOKINFO((FARPROC *)&Carrier::LaunchComplete_After, PLUGIN_HkIServerImpl_LaunchComplete, 0));
    p_PI->lstHooks.push_back(PLUGIN_HOOKINFO((FARPROC *)&Carrier::JumpInComplete_After, PLUGIN_HkIServerImpl_JumpInComplete, 0));
    p_PI->lstHooks.push_back(PLUGIN_HOOKINFO((FARPROC *)&Carrier::Dock_Call, PLUGIN_HkCb_Dock_Call, 0));
    p_PI->lstHooks.push_back(PLUGIN_HOOKINFO((FARPROC *)&Carrier::PlayerLaunch_After, PLUGIN_HkIServerImpl_PlayerLaunch_AFTER, 0));
    ...
    p_PI->lstHooks.push_back(PLUGIN_HOOKINFO((FARPROC *)&Insurance::DisConnect_After, PLUGIN_HkIServerImpl_DisConnect_AFTER, 0));
    p_PI->lstHooks.push_back(PLUGIN_HOOKINFO((FARPROC *)&Insurance::CharacterSelect_After, PLUGIN_HkIServerImpl_CharacterSelect_AFTER, 0));
    ...
    p_PI->lstHooks.push_back(PLUGIN_HOOKINFO((FARPROC *)&DeathPenalty::Initialize, PLUGIN_HkTimerCheckKick, 0));
    p_PI->lstHooks.push_back(PLUGIN_HOOKINFO((FARPROC *)&DeathPenalty::CreateNewCharacter_After, PLUGIN_HkIServerImpl_CreateNewCharacter_AFTER, 0));
    p_PI->lstHooks.push_back(PLUGIN_HOOKINFO((FARPROC *)&DeathPenalty::DestroyCharacter_After, PLUGIN_HkIServerImpl_DestroyCharacter_AFTER, 0));
    p_PI->lstHooks.push_back(PLUGIN_HOOKINFO((FARPROC *)&DeathPenalty::BaseEnter_After, PLUGIN_HkIServerImpl_BaseEnter_AFTER, 0));
    p_PI->lstHooks.push_back(PLUGIN_HOOKINFO((FARPROC *)&DeathPenalty::BaseExit_After, PLUGIN_HkIServerImpl_BaseExit_AFTER, 0));
    p_PI->lstHooks.push_back(PLUGIN_HOOKINFO((FARPROC *)&DeathPenalty::ShipDestroyed, PLUGIN_ShipDestroyed, 0));
    p_PI->lstHooks.push_back(PLUGIN_HOOKINFO((FARPROC *)&DeathPenalty::HkRename, PLUGIN_HkCb_Rename, 0));
    ...
    p_PI->lstHooks.push_back(PLUGIN_HOOKINFO((FARPROC *)&Duel::DisConnect_After, PLUGIN_HkIServerImpl_DisConnect_AFTER, 0));
    p_PI->lstHooks.push_back(PLUGIN_HOOKINFO((FARPROC *)&Duel::CharacterSelect_After, PLUGIN_HkIServerImpl_CharacterSelect_AFTER, 0));
    p_PI->lstHooks.push_back(PLUGIN_HOOKINFO((FARPROC *)&Duel::BaseExit_After, PLUGIN_HkIServerImpl_BaseExit_AFTER, 0));
    p_PI->lstHooks.push_back(PLUGIN_HOOKINFO((FARPROC *)&Duel::PlayerLaunch_After, PLUGIN_HkIServerImpl_PlayerLaunch_AFTER, 0));
