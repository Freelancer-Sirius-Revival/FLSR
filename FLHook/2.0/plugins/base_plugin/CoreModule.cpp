...
void CoreModule::Spawn() {
    if (!space_obj) {
        ...
        pub::SpaceObj::SetRelativeHealth(space_obj, base->base_health /
            ...
            if (time % 28800 == 0) {
                for (auto i = set_base_crew_consumption_items.begin();
                    ...
                    // Insufficient water and oxygen, kill crew.
                        ...
                        base->RemoveMarketGood(
                            set_base_crew_type,
                            (number_of_crew >= 10) ? 10 : number_of_crew);
                    }
                }
...
bool CoreModule::SpaceObjDestroyed(uint space_obj) {
    if (this->space_obj == space_obj) {
        ...
        // Careful not to access this as this object will have been deleted by
        // now.
        return true;
    }
    return false;
