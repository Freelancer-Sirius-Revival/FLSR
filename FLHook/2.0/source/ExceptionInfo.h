...
/* Inspired by Dr. Dobb's "Visual C++ Exception-Handling Instrumentation"
 * article.
...
struct __vcrt_ptd {
    ...
    int _CatchStateInParent; // Used to link together the catch funclet with the
                             // parent. During dispatch contains state
                             // associated with catch in the parent. During
...
//-----------------------------------------------------------------------------------------------------------
// These definitions are based on assembly listings produced by the compiler
// (/FAs) rather than built-in ones
//-----------------------------------------------------------------------------------------------------------
